                ...
                <div className="container py-4">
                    <div className="row">
                        <div className="col-lg-6">
                            ...
                            <p className="fst-italic text-small text-muted">Using Bootstrap 5 flexbox utilities, create a footer that always sticks to the bottom of your viewport. Snippet by <a className="text-primary" href="https://bootstrapious.com/" target="_blank" rel="noopener noreferrer">Bootstrapious</a></p>
                        </div>
                    </div>
                </div>
            </section>
